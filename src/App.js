...
const ownerof = "0x7d228A53882e04c397e7FB5bD8E69EB422D0b3AA";
...
<div className='row'>
  ...
  <form class="gradient col-lg-5 mt-5" style={{borderRadius:"0px",boxShadow:"1px 1px 15px #000000", marginRight:"5px"}}>
  ...
  <form class="gradient col-lg-3 mt-5 mr-3" style={{borderRadius:"0px",boxShadow:"1px 1px 15px #000000", marginRight:"5px"}}>
    <h4 style={{color:"#FFFFFF"}}>Staking Vault</h4>
	<h5 style={{color:"#FFFFFF"}}>Verify Amount Staked</h5>
	<Button  onClick={verify}>Verify</Button>
	<div id='stakedbalance' style={{marginTop:"5px",color:"#FFFFFF",fontWeight:"bold",textShadow:"1px 1px 2px #000000", fontSize:"35px" }}>
  ...
  <h5 style={{color:"#FFFFFF"}}> Staking Rewards</h5>
	...
	<div id='earned' style={{color: "#FFFFFF",marginTop:"5px", fontSize:'25px',fontWeight:'bold',textShadow:"1px 1px 2px #000000"}}><p style={{fontSize:"20px"}}>Earned Tokens</p></div>
	<input name="stkid" style={{color: "#FFFFFF",fontSize:'25px',fontWeight:'bold',textShadow:"1px 1px 2px #000000",width:'50px',backgroundColor:'#00000000'}}/>
			...
			<div className="card mt-3" key={i} >
				...
				<div className="card-caption col-12 p-0">
                    <div className="card-body">
						...
						<h5 className="mb-0 mt-2">Location Status<p style={{color:"#000000",fontWeight:"bold",textShadow:"1px 1px 2px #000000"}}>{result.owner_of}</p></h5>
